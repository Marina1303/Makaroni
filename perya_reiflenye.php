...
<div class="windSend"></div>
	<div class="formSEnd">
		<form action="perya_reiflenye.php" method="POST">
...
<div class="elementy-saita" id="content">
 ...
 <div class="box-contener" id="main" >
  <div class="img_prod">
       <img src="image/Макароны/Перья рифленые.jpg" >
       </div>
     <div class="H2 nameProd">Перья рифленые</div>
		<div >Описание</div>
		<p id="p">      Макароны Перья рифленые созданы для тех, кто ценит безупречный вкус и экономит время. Продукт позволит приготовить сытный и вкусный ужин всего за несколько минут, не опасаясь, что гребешки разварятся. Благодаря твердым сортам пшеницы, из которых были созданы макароны MAKFA, они прекрасно сохраняют форму и свои вкусовые качества при варке. Продукт высшего сорта прекрасно подходит в качестве гарнира к мясу и отлично сочетается с сырными соусами и томатной пастой. <br>
<b>Состав:</b><br>
