...
<div class="windSend"></div>
	<div class="formSEnd">
		<form action="kukolki.php" method="POST">
			...
			<input type="text" placeholder="Количество" name="count" class="inputSend priseBox" value="1" id="count" onblur="check(this.form.count.value)">
...
<div class="elementy-saita" id="content">
 ...
 <div class="box-contener" id="main" >
  <div class="img_prod">
       <img src="image/Макароны/Куколки.jpg" >
       </div>
     <div class="H2 nameProd">Куколки</div>
		<p><div >Описание</div></p>
		<p id="p">      Макароны Куколки созданы для тех, кто ценит безупречный вкус и экономит время. Продукт позволит приготовить сытный и вкусный ужин всего за несколько минут, не опасаясь, что гребешки разварятся. Благодаря твердым сортам пшеницы, из которых были созданы макароны MAKFA, они прекрасно сохраняют форму и свои вкусовые качества при варке. Продукт высшего сорта прекрасно подходит в качестве гарнира к мясу и отлично сочетается с сырными соусами и томатной пастой. <br>
<b>Состав:</b><br>
